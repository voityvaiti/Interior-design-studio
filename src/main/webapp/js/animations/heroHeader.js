...
export function heroHeaderReveal() {
  ...
  heroHeader.children[0].style.animation = "reveal 1s ease-in-out";
  setTimeout(() => {
    heroHeader.children[0].style.opacity = '1'
  }, 900);
  setTimeout(() => {
    heroHeader.children[1].style.animation = "reveal 1s ease-in-out";
    heroHeader.children[1].style.opacity = '1'
  }, 250);
  setTimeout(() => {
    heroHeader.children[2].style.animation = "reveal 1s ease-in-out";
